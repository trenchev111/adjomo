...
?> 
	...
	<div class="first-section container-fluid">
		<h1>Monetize your traffic with local advertisers</h1>
		...
		<div class="call-to-action-buttons">
			...
			<button class="btn btn-default">Become a Publisher</button>
	...
	<div class="second-section container-fluid">
		<div class="carousel-slider-phone">
		...
		<div class="how-to container">
			...
			<div class="row second-column">
				<div class="action-text">
					...
					<p class="col-md-5 offset-md-4 pull-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia ab commodi ipsum enim odio debitis labore,
					 quibusdam autem, eius placeat numquam corporis id cumque repellendus illum ullam, asperiores molestiae eos!</p>
				</div>
				<img src="assets/img/mac.png" alt="mac_right" class="mac-img-right pull-right">
				<img src="assets/img/iphone-right.png" alt="iphone-right" class="iphone-right-img-right">					
			</div>
